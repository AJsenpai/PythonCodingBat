...
# value with 0=no, 1=maybe, 2=yes. If either of you is very stylish, 8 or more, then the result is 2 (yes). 
...
# love6
# The number 6 is a truly great number. Given two int values, a and b, return True if either one is 6. Or if their sum or difference 
# is 6. Note: the function abs(num) computes the absolute value of a number.
...
# in1to10
# Given a number n, return True if n is in the range 1..10, inclusive. Unless outside_mode is True, in which case return True if the 
...
def near_ten(num):
  return True if (num + 2) % 10 <=4 else False
